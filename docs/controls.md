# Controls Definition
**UUID:** 4b92fc64-4d25-4bee-bb42-bb8f337f097d
**ISA-95 Level:** L4 Business
**Directory:** `/docs/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `docs` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/plc`
- **Interface:** `docs/plc.html`
- **Scan Time:** N/A
...
Examples:
- DOCS_PLC_Status_Running
- DOCS_HMI_Alarm_Count
- DOCS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/plc
    ↓
SCADA Systems (L2) - /docs/scada.html
    ↓
MES Layer (L3) - /docs/
    ↓
Business Layer (L4)

# Controls Definition
**UUID:** 86edf268-b078-4ac1-b3bd-7b919c2eb4b5
**ISA-95 Level:** L4 Business
**Directory:** `/docs/presentation/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `presentation` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/presentation/plc`
- **Interface:** `docs/presentation/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/presentation/hmi.html`
...
- **Path:** `/docs/presentation/scada.html`
...
Examples:
- PRESENTATION_PLC_Status_Running
- PRESENTATION_HMI_Alarm_Count
- PRESENTATION_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/presentation/plc
    ↓
SCADA Systems (L2) - /docs/presentation/scada.html
    ↓
MES Layer (L3) - /docs/presentation/
    ↓
Business Layer (L4)
```

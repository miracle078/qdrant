# Controls Definition
**UUID:** 5f5af8ca-f87c-4baa-8705-4a68aa24c48a
**ISA-95 Level:** L4 Business
**Directory:** `/docs/planning/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `planning` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/planning/plc`
- **Interface:** `docs/planning/plc.html`
- **Scan Time:** N/A
...
Examples:
- PLANNING_PLC_Status_Running
- PLANNING_HMI_Alarm_Count
- PLANNING_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/planning/plc
    ↓
SCADA Systems (L2) - /docs/planning/scada.html
    ↓
MES Layer (L3) - /docs/planning/
    ↓
Business Layer (L4)
```

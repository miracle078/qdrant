# Controls Definition
**UUID:** 36493cd7-a1cf-4ccd-8875-a54ea90f06c6
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/protocols/modbus/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `modbus` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/protocols/modbus/plc`
- **Interface:** `docs/standards/protocols/modbus/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/protocols/modbus/hmi.html`
...
- **Path:** `/docs/standards/protocols/modbus/scada.html`
...
Examples:
- MODBUS_PLC_Status_Running
- MODBUS_HMI_Alarm_Count
- MODBUS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/protocols/modbus/plc
    ↓
SCADA Systems (L2) - /docs/standards/protocols/modbus/scada.html
    ↓
MES Layer (L3) - /docs/standards/protocols/modbus/
    ↓
Business Layer (L4)
```

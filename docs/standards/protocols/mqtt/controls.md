# Controls Definition
**UUID:** a38fafe8-c0a7-428f-b576-588136925093
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/protocols/mqtt/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `mqtt` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/protocols/mqtt/plc`
- **Interface:** `docs/standards/protocols/mqtt/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/protocols/mqtt/hmi.html`
...
- **Path:** `/docs/standards/protocols/mqtt/scada.html`
...
Examples:
- MQTT_PLC_Status_Running
- MQTT_HMI_Alarm_Count
- MQTT_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/protocols/mqtt/plc
    ↓
SCADA Systems (L2) - /docs/standards/protocols/mqtt/scada.html
    ↓
MES Layer (L3) - /docs/standards/protocols/mqtt/
    ↓
Business Layer (L4)
```

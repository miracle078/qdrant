# Controls Definition
**UUID:** 0029da41-e314-410b-ad0c-2f08238a607d
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/protocols/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `protocols` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/protocols/plc`
- **Interface:** `docs/standards/protocols/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/protocols/hmi.html`
...
- **Path:** `/docs/standards/protocols/scada.html`
...
Examples:
- PROTOCOLS_PLC_Status_Running
- PROTOCOLS_HMI_Alarm_Count
- PROTOCOLS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/protocols/plc
    ↓
SCADA Systems (L2) - /docs/standards/protocols/scada.html
    ↓
MES Layer (L3) - /docs/standards/protocols/
    ↓
Business Layer (L4)
```

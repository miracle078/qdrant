# Controls Definition
**UUID:** 9d989220-cf1e-4bb7-aa75-df2fbc7dc9fe
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/protocols/opc-ua/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `opc-ua` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/protocols/opc-ua/plc`
- **Interface:** `docs/standards/protocols/opc-ua/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/protocols/opc-ua/hmi.html`
...
- **Path:** `/docs/standards/protocols/opc-ua/scada.html`
...
Examples:
- OPC-UA_PLC_Status_Running
- OPC-UA_HMI_Alarm_Count
- OPC-UA_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/protocols/opc-ua/plc
    ↓
SCADA Systems (L2) - /docs/standards/protocols/opc-ua/scada.html
    ↓
MES Layer (L3) - /docs/standards/protocols/opc-ua/
    ↓
Business Layer (L4)
```

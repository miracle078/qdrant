# Controls Definition
**UUID:** 88c3406c-1c9a-46ee-96aa-4580dfffbb94
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `standards` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/plc`
- **Interface:** `docs/standards/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/scada.html`
...
Examples:
- STANDARDS_PLC_Status_Running
- STANDARDS_HMI_Alarm_Count
- STANDARDS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/plc
    ↓
SCADA Systems (L2) - /docs/standards/scada.html
    ↓
MES Layer (L3) - /docs/standards/
    ↓
Business Layer (L4)
```

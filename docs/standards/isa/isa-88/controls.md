# Controls Definition
**UUID:** 6b7817c7-e57f-48a7-bdf3-0a567b8dbb3a
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/isa/isa-88/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `isa-88` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/isa/isa-88/plc`
- **Interface:** `docs/standards/isa/isa-88/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/isa/isa-88/hmi.html`
...
- **Path:** `/docs/standards/isa/isa-88/scada.html`
...
Examples:
- ISA-88_PLC_Status_Running
- ISA-88_HMI_Alarm_Count
- ISA-88_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/isa/isa-88/plc
    ↓
SCADA Systems (L2) - /docs/standards/isa/isa-88/scada.html
    ↓
MES Layer (L3) - /docs/standards/isa/isa-88/
    ↓
Business Layer (L4)
```

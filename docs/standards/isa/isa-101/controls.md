# Controls Definition
**UUID:** ec26dc37-fe5c-434b-83e8-d3911cee7e83
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/isa/isa-101/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `isa-101` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/isa/isa-101/plc`
- **Interface:** `docs/standards/isa/isa-101/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/isa/isa-101/hmi.html`
...
- **Path:** `/docs/standards/isa/isa-101/scada.html`
...
Examples:
- ISA-101_PLC_Status_Running
- ISA-101_HMI_Alarm_Count
- ISA-101_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/isa/isa-101/plc
    ↓
SCADA Systems (L2) - /docs/standards/isa/isa-101/scada.html
    ↓
MES Layer (L3) - /docs/standards/isa/isa-101/
    ↓
Business Layer (L4)
```

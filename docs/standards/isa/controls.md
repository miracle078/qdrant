# Controls Definition
**UUID:** fbe5e340-f33e-44d5-9c4c-30dc3f8620bc
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/isa/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `isa` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/isa/plc`
- **Interface:** `docs/standards/isa/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/isa/hmi.html`
...
- **Path:** `/docs/standards/isa/scada.html`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/isa/plc
    ↓
SCADA Systems (L2) - /docs/standards/isa/scada.html
    ↓
MES Layer (L3) - /docs/standards/isa/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 4f016a11-ffcc-411f-bbd5-15a8cf490874
**ISA-95 Level:** L4 Business
**Directory:** `/docs/standards/isa/isa-95/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `isa-95` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/standards/isa/isa-95/plc`
- **Interface:** `docs/standards/isa/isa-95/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/docs/standards/isa/isa-95/hmi.html`
...
- **Path:** `/docs/standards/isa/isa-95/scada.html`
...
Examples:
- ISA-95_PLC_Status_Running
- ISA-95_HMI_Alarm_Count
- ISA-95_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/standards/isa/isa-95/plc
    ↓
SCADA Systems (L2) - /docs/standards/isa/isa-95/scada.html
    ↓
MES Layer (L3) - /docs/standards/isa/isa-95/
    ↓
Business Layer (L4)
```

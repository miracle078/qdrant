# Controls Definition
**UUID:** a3e0a3a3-7ca9-4403-a3ce-f9afdea771b2
**ISA-95 Level:** L4 Business
**Directory:** `/docs/guides/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `guides` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/docs/guides/plc`
- **Interface:** `docs/guides/plc.html`
- **Scan Time:** N/A
...
Examples:
- GUIDES_PLC_Status_Running
- GUIDES_HMI_Alarm_Count
- GUIDES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /docs/guides/plc
    ↓
SCADA Systems (L2) - /docs/guides/scada.html
    ↓
MES Layer (L3) - /docs/guides/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 6a95e07c-fe3f-4b48-a306-4da3ec1e3d5d
**ISA-95 Level:** L3/L4 Operations
**Directory:** `/cli/backup/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `backup` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/cli/backup/plc`
- **Interface:** `cli/backup/plc.html`
- **Scan Time:** N/A
...
Examples:
- BACKUP_PLC_Status_Running
- BACKUP_HMI_Alarm_Count
- BACKUP_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /cli/backup/plc
    ↓
SCADA Systems (L2) - /cli/backup/scada.html
    ↓
MES Layer (L3) - /cli/backup/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 6183de0d-84dc-4c18-a8fc-db33df6c6e68
**ISA-95 Level:** L3/L4 Operations
**Directory:** `/cli/models/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `models` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/cli/models/plc`
- **Interface:** `cli/models/plc.html`
- **Scan Time:** N/A
...
Examples:
- MODELS_PLC_Status_Running
- MODELS_HMI_Alarm_Count
- MODELS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /cli/models/plc
    ↓
SCADA Systems (L2) - /cli/models/scada.html
    ↓
MES Layer (L3) - /cli/models/
    ↓
Business Layer (L4)
```

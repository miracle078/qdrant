# Controls Definition
**UUID:** 7a01d767-be8e-46eb-a4cf-153c4bb219c6
**ISA-95 Level:** L3/L4 Operations
**Directory:** `/cli/dev/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `dev` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/cli/dev/plc`
- **Interface:** `cli/dev/plc.html`
- **Scan Time:** N/A
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /cli/dev/plc
    ↓
SCADA Systems (L2) - /cli/dev/scada.html
    ↓
MES Layer (L3) - /cli/dev/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 9ed88f94-c7e6-4d2d-9c5a-298b75edcb25
**ISA-95 Level:** L3/L4 Operations
**Directory:** `/cli/logs/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `logs` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/cli/logs/plc`
- **Interface:** `cli/logs/plc.html`
- **Scan Time:** N/A
...
Examples:
- LOGS_PLC_Status_Running
- LOGS_HMI_Alarm_Count
- LOGS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /cli/logs/plc
    ↓
SCADA Systems (L2) - /cli/logs/scada.html
    ↓
MES Layer (L3) - /cli/logs/
    ↓
Business Layer (L4)
```

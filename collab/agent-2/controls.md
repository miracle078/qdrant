# Controls Definition
**UUID:** a4a7cadf-8009-4772-92eb-b32505b4f47b
**ISA-95 Level:** L4 Business
**Directory:** `/collab/agent-2/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `agent-2` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/agent-2/plc`
- **Interface:** `collab/agent-2/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/collab/agent-2/scada.html`
...
Examples:
- AGENT-2_PLC_Status_Running
- AGENT-2_HMI_Alarm_Count
- AGENT-2_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/agent-2/plc
    ↓
SCADA Systems (L2) - /collab/agent-2/scada.html
    ↓
MES Layer (L3) - /collab/agent-2/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 3f529016-9a17-440e-8151-8a0a5b8e52b2
**ISA-95 Level:** L4 Business
**Directory:** `/collab/3d-worlds/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `3d-worlds` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/3d-worlds/plc`
- **Interface:** `collab/3d-worlds/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/collab/3d-worlds/hmi.html`
...
- **Path:** `/collab/3d-worlds/scada.html`
...
Examples:
- 3D-WORLDS_PLC_Status_Running
- 3D-WORLDS_HMI_Alarm_Count
- 3D-WORLDS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/3d-worlds/plc
    ↓
SCADA Systems (L2) - /collab/3d-worlds/scada.html
    ↓
MES Layer (L3) - /collab/3d-worlds/
    ↓
Business Layer (L4)
```

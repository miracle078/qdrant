# Controls Definition
**UUID:** de2b9d6b-bc02-459b-9050-92eec724b999
**ISA-95 Level:** L4 Business
**Directory:** `/collab/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `collab` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/plc`
- **Interface:** `collab/plc.html`
- **Scan Time:** N/A
...
Examples:
- COLLAB_PLC_Status_Running
- COLLAB_HMI_Alarm_Count
- COLLAB_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/plc
    ↓
SCADA Systems (L2) - /collab/scada.html
    ↓
MES Layer (L3) - /collab/
    ↓
Business Layer (L4)

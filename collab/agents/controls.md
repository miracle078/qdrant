# Controls Definition
**UUID:** d92de25c-a7cb-4fba-929d-074bad678d15
**ISA-95 Level:** L4 Business
**Directory:** `/collab/agents/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `agents` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/agents/plc`
- **Interface:** `collab/agents/plc.html`
- **Scan Time:** N/A
...
Examples:
- AGENTS_PLC_Status_Running
- AGENTS_HMI_Alarm_Count
- AGENTS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/agents/plc
    ↓
SCADA Systems (L2) - /collab/agents/scada.html
    ↓
MES Layer (L3) - /collab/agents/
    ↓
Business Layer (L4)
```

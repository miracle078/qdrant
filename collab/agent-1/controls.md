# Controls Definition
**UUID:** 515bc291-9cb7-4730-8a32-e117049dad2c
**ISA-95 Level:** L4 Business
**Directory:** `/collab/agent-1/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `agent-1` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/agent-1/plc`
- **Interface:** `collab/agent-1/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/collab/agent-1/scada.html`
...
Examples:
- AGENT-1_PLC_Status_Running
- AGENT-1_HMI_Alarm_Count
- AGENT-1_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/agent-1/plc
    ↓
SCADA Systems (L2) - /collab/agent-1/scada.html
    ↓
MES Layer (L3) - /collab/agent-1/
    ↓
Business Layer (L4)
```

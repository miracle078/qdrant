# Controls Definition
**UUID:** 52d78cd1-5705-4b1f-a621-538cd675d286
**ISA-95 Level:** L4 Business
**Directory:** `/collab/databases/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `databases` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/databases/plc`
- **Interface:** `collab/databases/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/collab/databases/hmi.html`
...
- **Path:** `/collab/databases/scada.html`
...
Examples:
- DATABASES_PLC_Status_Running
- DATABASES_HMI_Alarm_Count
- DATABASES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/databases/plc
    ↓
SCADA Systems (L2) - /collab/databases/scada.html
    ↓
MES Layer (L3) - /collab/databases/
    ↓
Business Layer (L4)
```

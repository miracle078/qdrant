# Controls Definition
**UUID:** 8d60bf91-30bd-4af6-a8b7-375cc1df273e
**ISA-95 Level:** L4 Business
**Directory:** `/collab/miracle/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `miracle` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/miracle/plc`
- **Interface:** `collab/miracle/plc.html`
- **Scan Time:** N/A
...
- **Path:** `/collab/miracle/scada.html`
...
Examples:
- MIRACLE_PLC_Status_Running
- MIRACLE_HMI_Alarm_Count
- MIRACLE_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/miracle/plc
    ↓
SCADA Systems (L2) - /collab/miracle/scada.html
    ↓
MES Layer (L3) - /collab/miracle/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** a8b5f25b-22c3-4f36-828b-3debcf840655
**ISA-95 Level:** L4 Business
**Directory:** `/collab/tom/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `tom` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/collab/tom/plc`
- **Interface:** `collab/tom/plc.html`
- **Scan Time:** N/A
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /collab/tom/plc
    ↓
SCADA Systems (L2) - /collab/tom/scada.html
    ↓
MES Layer (L3) - /collab/tom/
    ↓
Business Layer (L4)
```

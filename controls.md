# Controls Definition
**UUID:** f61f2b77-20ec-4e96-ab99-235f644ab330
**ISA-95 Level:** L4 Business
**Directory:** `/./`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `qdrant` subsystem.
...
Examples:
- QDRANT_PLC_Status_Running
- QDRANT_HMI_Alarm_Count
- QDRANT_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /./plc
    ↓
SCADA Systems (L2) - /./scada.html
    ↓
MES Layer (L3) - /./
    ↓
Business Layer (L4)

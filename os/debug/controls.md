# Controls Definition
**UUID:** f89db3c1-9a7c-4cf0-b360-a7077c7757d6
**ISA-95 Level:** L3 MES
**Directory:** `/os/debug/`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/debug/plc
    ↓
SCADA Systems (L2) - /os/debug/scada.html
    ↓
MES Layer (L3) - /os/debug/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 251553d3-8334-492c-afda-644aec27569b
**ISA-95 Level:** L3 MES
**Directory:** `/os/equipment/control-modules/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `control-modules` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/equipment/control-modules/plc`
- **Interface:** `os/equipment/control-modules/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/equipment/control-modules/hmi.html`
...
- **Path:** `/os/equipment/control-modules/scada.html`
...
Examples:
- CONTROL-MODULES_PLC_Status_Running
- CONTROL-MODULES_HMI_Alarm_Count
- CONTROL-MODULES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/equipment/control-modules/plc
    ↓
SCADA Systems (L2) - /os/equipment/control-modules/scada.html
    ↓
MES Layer (L3) - /os/equipment/control-modules/
    ↓
Business Layer (L4)
```

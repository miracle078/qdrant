# Controls Definition
**UUID:** f68703a0-7d23-490a-bc0c-61dd56a16497
**ISA-95 Level:** L3 MES
**Directory:** `/os/equipment/process-cells/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `process-cells` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/equipment/process-cells/plc`
- **Interface:** `os/equipment/process-cells/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/equipment/process-cells/hmi.html`
...
- **Path:** `/os/equipment/process-cells/scada.html`
...
Examples:
- PROCESS-CELLS_PLC_Status_Running
- PROCESS-CELLS_HMI_Alarm_Count
- PROCESS-CELLS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/equipment/process-cells/plc
    ↓
SCADA Systems (L2) - /os/equipment/process-cells/scada.html
    ↓
MES Layer (L3) - /os/equipment/process-cells/
    ↓
Business Layer (L4)
```

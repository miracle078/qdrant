# Controls Definition
**UUID:** 4d08a9f9-b462-4582-9d31-9fdde21cd2ed
**ISA-95 Level:** L3 MES
**Directory:** `/os/equipment/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `equipment` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/equipment/plc`
- **Interface:** `os/equipment/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- EQUIPMENT_PLC_Status_Running
- EQUIPMENT_HMI_Alarm_Count
- EQUIPMENT_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/equipment/plc
    ↓
SCADA Systems (L2) - /os/equipment/scada.html
    ↓
MES Layer (L3) - /os/equipment/
    ↓
Business Layer (L4)
```

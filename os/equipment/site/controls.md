# Controls Definition
**UUID:** e7b908ac-e9f0-4995-9260-65b27493d714
**ISA-95 Level:** L3 MES
**Directory:** `/os/equipment/site/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `site` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/equipment/site/plc`
- **Interface:** `os/equipment/site/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/equipment/site/hmi.html`
...
- **Path:** `/os/equipment/site/scada.html`
...
Examples:
- SITE_PLC_Status_Running
- SITE_HMI_Alarm_Count
- SITE_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/equipment/site/plc
    ↓
SCADA Systems (L2) - /os/equipment/site/scada.html
    ↓
MES Layer (L3) - /os/equipment/site/
    ↓
Business Layer (L4)
```

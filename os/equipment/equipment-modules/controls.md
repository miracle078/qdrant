# Controls Definition
**UUID:** 16967aea-fd12-478c-bc70-fbeb1a5e4ad4
**ISA-95 Level:** L3 MES
**Directory:** `/os/equipment/equipment-modules/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `equipment-modules` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/equipment/equipment-modules/plc`
- **Interface:** `os/equipment/equipment-modules/plc.html`
- **Scan Time:** 500ms-1s
- **Tags:** ~114 process variables
- **Mode:** RUN
- **Logic:** Ladder logic, structured text, function blocks

### HMI (Human-Machine Interface)
- **Path:** `/os/equipment/equipment-modules/hmi.html`
...
- **Path:** `/os/equipment/equipment-modules/scada.html`
...
Examples:
- EQUIPMENT-MODULES_PLC_Status_Running
- EQUIPMENT-MODULES_HMI_Alarm_Count
- EQUIPMENT-MODULES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/equipment/equipment-modules/plc
    ↓
SCADA Systems (L2) - /os/equipment/equipment-modules/scada.html
    ↓
MES Layer (L3) - /os/equipment/equipment-modules/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 9d3e58b5-2105-46ab-9c3e-9e246b8a59e8
**ISA-95 Level:** L3 MES
**Directory:** `/os/equipment/units/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `units` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/equipment/units/plc`
- **Interface:** `os/equipment/units/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/equipment/units/hmi.html`
...
- **Path:** `/os/equipment/units/scada.html`
...
Examples:
- UNITS_PLC_Status_Running
- UNITS_HMI_Alarm_Count
- UNITS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/equipment/units/plc
    ↓
SCADA Systems (L2) - /os/equipment/units/scada.html
    ↓
MES Layer (L3) - /os/equipment/units/
    ↓
Business Layer (L4)
```

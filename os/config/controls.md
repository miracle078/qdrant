# Controls Definition
**UUID:** b3f38bf7-3fe9-4dd1-9ea3-3b0abed15d7e
**ISA-95 Level:** L3 MES
**Directory:** `/os/config/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `config` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/config/plc`
- **Interface:** `os/config/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- CONFIG_PLC_Status_Running
- CONFIG_HMI_Alarm_Count
- CONFIG_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/config/plc
    ↓
SCADA Systems (L2) - /os/config/scada.html
    ↓
MES Layer (L3) - /os/config/
    ↓
Business Layer (L4)
```

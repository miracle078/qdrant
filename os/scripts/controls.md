# Controls Definition
**UUID:** 339002f8-6f04-48d0-bedd-a60881c5f5f9
**ISA-95 Level:** L3 MES
**Directory:** `/os/scripts/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `scripts` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/scripts/plc`
- **Interface:** `os/scripts/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- SCRIPTS_PLC_Status_Running
- SCRIPTS_HMI_Alarm_Count
- SCRIPTS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/scripts/plc
    ↓
SCADA Systems (L2) - /os/scripts/scada.html
    ↓
MES Layer (L3) - /os/scripts/
    ↓
Business Layer (L4)
```

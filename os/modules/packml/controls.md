# Controls Definition
**UUID:** 677621a3-52d1-4bdc-b189-c439d9d080a2
**ISA-95 Level:** L3 MES
**Directory:** `/os/modules/packml/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `packml` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/modules/packml/plc`
- **Interface:** `os/modules/packml/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/modules/packml/hmi.html`
...
- **Path:** `/os/modules/packml/scada.html`
...
Examples:
- PACKML_PLC_Status_Running
- PACKML_HMI_Alarm_Count
- PACKML_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/modules/packml/plc
    ↓
SCADA Systems (L2) - /os/modules/packml/scada.html
    ↓
MES Layer (L3) - /os/modules/packml/
    ↓
Business Layer (L4)
```

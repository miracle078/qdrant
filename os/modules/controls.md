# Controls Definition
**UUID:** 0c90db8e-82c6-424d-b515-be3ac027b300
**ISA-95 Level:** L3 MES
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/modules/plc
    ↓
SCADA Systems (L2) - /os/modules/scada.html
    ↓
MES Layer (L3) - /os/modules/
    ↓
Business Layer (L4)
```

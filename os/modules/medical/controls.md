# Controls Definition
**UUID:** f8244957-d622-4e7d-b35a-afc421f541e2
**ISA-95 Level:** L3 MES
...
- **Path:** `/os/modules/medical/plc`
- **Interface:** `os/modules/medical/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/modules/medical/hmi.html`
...
- **Path:** `/os/modules/medical/scada.html`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/modules/medical/plc
    ↓
SCADA Systems (L2) - /os/modules/medical/scada.html
    ↓
MES Layer (L3) - /os/modules/medical/
    ↓
Business Layer (L4)
```

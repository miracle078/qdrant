# Controls Definition
**UUID:** 01978e2e-3eba-4af8-8ecf-f8f02ff13f9a
**ISA-95 Level:** L3 MES
**Directory:** `/os/modules/ai/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `ai` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/modules/ai/plc`
- **Interface:** `os/modules/ai/plc.html`
- **Scan Time:** 500ms-1s
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/modules/ai/plc
    ↓
SCADA Systems (L2) - /os/modules/ai/scada.html
    ↓
MES Layer (L3) - /os/modules/ai/
    ↓
Business Layer (L4)
```

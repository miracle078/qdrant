# Controls Definition
**UUID:** f5756141-a675-4f77-804c-c97cbe7f307c
**ISA-95 Level:** L3 MES
**Directory:** `/os/modules/cli/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `cli` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/modules/cli/plc`
- **Interface:** `os/modules/cli/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/modules/cli/scada.html`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/modules/cli/plc
    ↓
SCADA Systems (L2) - /os/modules/cli/scada.html
    ↓
MES Layer (L3) - /os/modules/cli/
    ↓
Business Layer (L4)
```

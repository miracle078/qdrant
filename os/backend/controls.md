# Controls Definition
**UUID:** 3e8f5a47-ef9f-4cd6-8c48-5488bd18318e
**ISA-95 Level:** L3 MES
**Directory:** `/os/backend/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `backend` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/backend/plc`
- **Interface:** `os/backend/plc.html`
- **Scan Time:** 500ms-1s
- **Tags:** ~28 process variables
- **Mode:** RUN
- **Logic:** Ladder logic, structured text, function blocks

### HMI (Human-Machine Interface)
- **Path:** `/os/backend/hmi.html`
...
Examples:
- BACKEND_PLC_Status_Running
- BACKEND_HMI_Alarm_Count
- BACKEND_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/backend/plc
    ↓
SCADA Systems (L2) - /os/backend/scada.html
    ↓
MES Layer (L3) - /os/backend/
    ↓
Business Layer (L4)
```

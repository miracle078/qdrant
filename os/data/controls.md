# Controls Definition
**UUID:** dd0fb912-c61e-4942-b137-7ac6faed8c7a
**ISA-95 Level:** L3 MES
**Directory:** `/os/data/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `data` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/data/plc`
- **Interface:** `os/data/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- DATA_PLC_Status_Running
- DATA_HMI_Alarm_Count
- DATA_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/data/plc
    ↓
SCADA Systems (L2) - /os/data/scada.html
    ↓
MES Layer (L3) - /os/data/
    ↓
Business Layer (L4)
```

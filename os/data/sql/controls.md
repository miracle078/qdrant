# Controls Definition
**UUID:** bc8fa6cd-142d-4a12-bb64-1335a5a4aa1f
**ISA-95 Level:** L3 MES
**Directory:** `/os/data/sql/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `sql` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/data/sql/plc`
- **Interface:** `os/data/sql/plc.html`
- **Scan Time:** 500ms-1s
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/data/sql/plc
    ↓
SCADA Systems (L2) - /os/data/sql/scada.html
    ↓
MES Layer (L3) - /os/data/sql/
    ↓
Business Layer (L4)
```

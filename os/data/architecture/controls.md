# Controls Definition
**UUID:** 115f01d6-5bcc-461d-93bc-662f869c0d37
**ISA-95 Level:** L3 MES
**Directory:** `/os/data/architecture/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `architecture` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/data/architecture/plc`
- **Interface:** `os/data/architecture/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/data/architecture/hmi.html`
...
- **Path:** `/os/data/architecture/scada.html`
...
Examples:
- ARCHITECTURE_PLC_Status_Running
- ARCHITECTURE_HMI_Alarm_Count
- ARCHITECTURE_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/data/architecture/plc
    ↓
SCADA Systems (L2) - /os/data/architecture/scada.html
    ↓
MES Layer (L3) - /os/data/architecture/
    ↓
Business Layer (L4)
```

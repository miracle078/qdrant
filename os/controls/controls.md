# Controls Definition
**UUID:** b46a2d8f-0aa6-4b33-b791-d632588ba45d
**ISA-95 Level:** L3 MES
**Directory:** `/os/controls/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `controls` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/controls/plc`
- **Interface:** `os/controls/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- CONTROLS_PLC_Status_Running
- CONTROLS_HMI_Alarm_Count
- CONTROLS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/controls/plc
    ↓
SCADA Systems (L2) - /os/controls/scada.html
    ↓
MES Layer (L3) - /os/controls/
    ↓
Business Layer (L4)
```

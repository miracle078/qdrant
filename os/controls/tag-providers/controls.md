# Controls Definition
**UUID:** de69348b-9f98-4de7-9d2c-e3165e51087d
**ISA-95 Level:** L3 MES
**Directory:** `/os/controls/tag-providers/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `tag-providers` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/controls/tag-providers/plc`
- **Interface:** `os/controls/tag-providers/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/controls/tag-providers/hmi.html`
...
- **Path:** `/os/controls/tag-providers/scada.html`
...
Examples:
- TAG-PROVIDERS_PLC_Status_Running
- TAG-PROVIDERS_HMI_Alarm_Count
- TAG-PROVIDERS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/controls/tag-providers/plc
    ↓
SCADA Systems (L2) - /os/controls/tag-providers/scada.html
    ↓
MES Layer (L3) - /os/controls/tag-providers/
    ↓
Business Layer (L4)
```

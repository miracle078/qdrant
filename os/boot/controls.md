# Controls Definition
**UUID:** 499c50da-20bf-4178-b983-d506728ee88c
**ISA-95 Level:** L3 MES
**Directory:** `/os/boot/`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/boot/plc
    ↓
SCADA Systems (L2) - /os/boot/scada.html
    ↓
MES Layer (L3) - /os/boot/
    ↓
Business Layer (L4)
```

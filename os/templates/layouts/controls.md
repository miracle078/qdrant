# Controls Definition
**UUID:** cdfa4a4a-eeb5-43e7-9e6d-54bd1975c802
**ISA-95 Level:** L3 MES
**Directory:** `/os/templates/layouts/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `layouts` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/templates/layouts/plc`
- **Interface:** `os/templates/layouts/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/templates/layouts/hmi.html`
...
- **Path:** `/os/templates/layouts/scada.html`
...
Examples:
- LAYOUTS_PLC_Status_Running
- LAYOUTS_HMI_Alarm_Count
- LAYOUTS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/templates/layouts/plc
    ↓
SCADA Systems (L2) - /os/templates/layouts/scada.html
    ↓
MES Layer (L3) - /os/templates/layouts/
    ↓
Business Layer (L4)
```

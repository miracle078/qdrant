# Controls Definition
**UUID:** 8bbb15ad-f7b3-4b94-a6f6-e4b3dde542c5
**ISA-95 Level:** L3 MES
**Directory:** `/os/templates/p-and-id/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `p-and-id` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/templates/p-and-id/plc`
- **Interface:** `os/templates/p-and-id/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/templates/p-and-id/hmi.html`
...
- **Path:** `/os/templates/p-and-id/scada.html`
...
Examples:
- P-AND-ID_PLC_Status_Running
- P-AND-ID_HMI_Alarm_Count
- P-AND-ID_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/templates/p-and-id/plc
    ↓
SCADA Systems (L2) - /os/templates/p-and-id/scada.html
    ↓
MES Layer (L3) - /os/templates/p-and-id/
    ↓
Business Layer (L4)
```

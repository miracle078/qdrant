# Controls Definition
**UUID:** 4d6ced9d-a548-4aa3-b07a-81721840354d
**ISA-95 Level:** L3 MES
**Directory:** `/os/templates/medical/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `medical` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/templates/medical/plc`
- **Interface:** `os/templates/medical/plc.html`
- **Scan Time:** 500ms-1s
- **Tags:** ~25 process variables
- **Mode:** RUN
- **Logic:** Ladder logic, structured text, function blocks

### HMI (Human-Machine Interface)
- **Path:** `/os/templates/medical/hmi.html`
...
- **Path:** `/os/templates/medical/scada.html`
...
Examples:
- MEDICAL_PLC_Status_Running
- MEDICAL_HMI_Alarm_Count
- MEDICAL_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/templates/medical/plc
    ↓
SCADA Systems (L2) - /os/templates/medical/scada.html
    ↓
MES Layer (L3) - /os/templates/medical/
    ↓
Business Layer (L4)
```

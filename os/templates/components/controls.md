# Controls Definition
**UUID:** 6e9a8402-6c61-48cd-9297-9ab728e3fb25
**ISA-95 Level:** L3 MES
**Directory:** `/os/templates/components/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `components` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/templates/components/plc`
- **Interface:** `os/templates/components/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/templates/components/hmi.html`
...
- **Path:** `/os/templates/components/scada.html`
...
Examples:
- COMPONENTS_PLC_Status_Running
- COMPONENTS_HMI_Alarm_Count
- COMPONENTS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/templates/components/plc
    ↓
SCADA Systems (L2) - /os/templates/components/scada.html
    ↓
MES Layer (L3) - /os/templates/components/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 23068cee-05fd-4242-ab40-96ac800d8397
**ISA-95 Level:** L3 MES
**Directory:** `/os/templates/views/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `views` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/templates/views/plc`
- **Interface:** `os/templates/views/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/templates/views/hmi.html`
...
- **Path:** `/os/templates/views/scada.html`
...
Examples:
- VIEWS_PLC_Status_Running
- VIEWS_HMI_Alarm_Count
- VIEWS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/templates/views/plc
    ↓
SCADA Systems (L2) - /os/templates/views/scada.html
    ↓
MES Layer (L3) - /os/templates/views/
    ↓
Business Layer (L4)
```

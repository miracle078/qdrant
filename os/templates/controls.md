# Controls Definition
**UUID:** f16408fe-4288-429b-954e-7b03bc3d147f
**ISA-95 Level:** L3 MES
**Directory:** `/os/templates/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `templates` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/templates/plc`
- **Interface:** `os/templates/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- TEMPLATES_PLC_Status_Running
- TEMPLATES_HMI_Alarm_Count
- TEMPLATES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/templates/plc
    ↓
SCADA Systems (L2) - /os/templates/scada.html
    ↓
MES Layer (L3) - /os/templates/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 06f30625-356a-4a64-b63e-d2c1ebdc55fc
**ISA-95 Level:** L3 MES
**Directory:** `/os/sandbox/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `sandbox` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/sandbox/plc`
- **Interface:** `os/sandbox/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- SANDBOX_PLC_Status_Running
- SANDBOX_HMI_Alarm_Count
- SANDBOX_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/sandbox/plc
    ↓
SCADA Systems (L2) - /os/sandbox/scada.html
    ↓
MES Layer (L3) - /os/sandbox/
    ↓
Business Layer (L4)
```

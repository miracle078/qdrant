# Controls Definition
**UUID:** 5cf39994-cd39-44cb-a6d3-c65ec806282b
**ISA-95 Level:** L3 MES
**Directory:** `/os/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `os` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/plc`
- **Interface:** `os/plc.html`
- **Scan Time:** 500ms-1s
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/plc
    ↓
SCADA Systems (L2) - /os/scada.html
    ↓
MES Layer (L3) - /os/
    ↓
Business Layer (L4)

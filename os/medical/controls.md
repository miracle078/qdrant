# Controls Definition
**UUID:** 9a07a9a8-5a0f-419b-a2bd-6d42460a868c
**ISA-95 Level:** L3 MES
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/medical/plc
    ↓
SCADA Systems (L2) - /os/medical/scada.html
    ↓
MES Layer (L3) - /os/medical/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 953f3dd8-4627-4ece-8ea1-31c772f32122
**ISA-95 Level:** L3 MES
**Directory:** `/os/language/trinary/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `trinary` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/language/trinary/plc`
- **Interface:** `os/language/trinary/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/language/trinary/hmi.html`
...
- **Path:** `/os/language/trinary/scada.html`
...
Examples:
- TRINARY_PLC_Status_Running
- TRINARY_HMI_Alarm_Count
- TRINARY_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/language/trinary/plc
    ↓
SCADA Systems (L2) - /os/language/trinary/scada.html
    ↓
MES Layer (L3) - /os/language/trinary/
    ↓
Business Layer (L4)
```

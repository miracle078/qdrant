# Controls Definition
**UUID:** 23752cf7-4c5c-452f-bb4e-5cc4856930c4
**ISA-95 Level:** L3 MES
**Directory:** `/os/language/trinary/compiler/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `compiler` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/language/trinary/compiler/plc`
- **Interface:** `os/language/trinary/compiler/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/language/trinary/compiler/hmi.html`
...
- **Path:** `/os/language/trinary/compiler/scada.html`
...
Examples:
- COMPILER_PLC_Status_Running
- COMPILER_HMI_Alarm_Count
- COMPILER_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/language/trinary/compiler/plc
    ↓
SCADA Systems (L2) - /os/language/trinary/compiler/scada.html
    ↓
MES Layer (L3) - /os/language/trinary/compiler/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 5885dce4-8f18-4ca2-9b5c-d9d6a4f6fdc9
**ISA-95 Level:** L3 MES
**Directory:** `/os/language/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `language` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/language/plc`
- **Interface:** `os/language/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- LANGUAGE_PLC_Status_Running
- LANGUAGE_HMI_Alarm_Count
- LANGUAGE_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/language/plc
    ↓
SCADA Systems (L2) - /os/language/scada.html
    ↓
MES Layer (L3) - /os/language/
    ↓
Business Layer (L4)
```

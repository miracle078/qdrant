# Controls Definition
**UUID:** 8d0e248e-8a64-4621-8173-eb09a2f16258
**ISA-95 Level:** L3 MES
**Directory:** `/os/language/snt/examples/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `examples` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/language/snt/examples/plc`
- **Interface:** `os/language/snt/examples/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/language/snt/examples/hmi.html`
...
- **Path:** `/os/language/snt/examples/scada.html`
...
Examples:
- EXAMPLES_PLC_Status_Running
- EXAMPLES_HMI_Alarm_Count
- EXAMPLES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/language/snt/examples/plc
    ↓
SCADA Systems (L2) - /os/language/snt/examples/scada.html
    ↓
MES Layer (L3) - /os/language/snt/examples/
    ↓
Business Layer (L4)
```

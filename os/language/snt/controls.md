# Controls Definition
**UUID:** 8370bb0e-e90b-420b-8942-ef294cdbb68c
**ISA-95 Level:** L3 MES
**Directory:** `/os/language/snt/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `snt` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/language/snt/plc`
- **Interface:** `os/language/snt/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/language/snt/scada.html`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/language/snt/plc
    ↓
SCADA Systems (L2) - /os/language/snt/scada.html
    ↓
MES Layer (L3) - /os/language/snt/
    ↓
Business Layer (L4)
```

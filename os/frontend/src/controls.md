# Controls Definition
**UUID:** 7d43bad6-d31b-4712-b352-72267693fbd2
**ISA-95 Level:** L3 MES
**Directory:** `/os/frontend/src/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `src` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/frontend/src/plc`
- **Interface:** `os/frontend/src/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/frontend/src/scada.html`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/frontend/src/plc
    ↓
SCADA Systems (L2) - /os/frontend/src/scada.html
    ↓
MES Layer (L3) - /os/frontend/src/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 31fae814-b39a-4995-998a-b074e80ede47
**ISA-95 Level:** L3 MES
**Directory:** `/os/frontend/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `frontend` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/frontend/plc`
- **Interface:** `os/frontend/plc.html`
- **Scan Time:** 500ms-1s
- **Tags:** ~47 process variables
- **Mode:** RUN
- **Logic:** Ladder logic, structured text, function blocks

### HMI (Human-Machine Interface)
- **Path:** `/os/frontend/hmi.html`
...
Examples:
- FRONTEND_PLC_Status_Running
- FRONTEND_HMI_Alarm_Count
- FRONTEND_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/frontend/plc
    ↓
SCADA Systems (L2) - /os/frontend/scada.html
    ↓
MES Layer (L3) - /os/frontend/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 746bf02a-6bf3-4cc2-bc4f-72b70189c5c9
**ISA-95 Level:** L3 MES
**Directory:** `/os/frontend/public/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `public` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/frontend/public/plc`
- **Interface:** `os/frontend/public/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/frontend/public/hmi.html`
...
- **Path:** `/os/frontend/public/scada.html`
...
Examples:
- PUBLIC_PLC_Status_Running
- PUBLIC_HMI_Alarm_Count
- PUBLIC_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/frontend/public/plc
    ↓
SCADA Systems (L2) - /os/frontend/public/scada.html
    ↓
MES Layer (L3) - /os/frontend/public/
    ↓
Business Layer (L4)
```

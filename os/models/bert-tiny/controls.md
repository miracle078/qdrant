# Controls Definition
**UUID:** 67eb08f1-c183-424a-bdb3-64ed18d213a6
**ISA-95 Level:** L3 MES
**Directory:** `/os/models/bert-tiny/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `bert-tiny` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/models/bert-tiny/plc`
- **Interface:** `os/models/bert-tiny/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/models/bert-tiny/hmi.html`
...
- **Path:** `/os/models/bert-tiny/scada.html`
...
Examples:
- BERT-TINY_PLC_Status_Running
- BERT-TINY_HMI_Alarm_Count
- BERT-TINY_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/models/bert-tiny/plc
    ↓
SCADA Systems (L2) - /os/models/bert-tiny/scada.html
    ↓
MES Layer (L3) - /os/models/bert-tiny/
    ↓
Business Layer (L4)
```

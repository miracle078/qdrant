# Controls Definition
**UUID:** fd26b906-9ec8-42ca-858f-fcf71d27fad0
**ISA-95 Level:** L3 MES
**Directory:** `/os/models/mobilenet-v2/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `mobilenet-v2` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/models/mobilenet-v2/plc`
- **Interface:** `os/models/mobilenet-v2/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/models/mobilenet-v2/hmi.html`
...
- **Path:** `/os/models/mobilenet-v2/scada.html`
...
Examples:
- MOBILENET-V2_PLC_Status_Running
- MOBILENET-V2_HMI_Alarm_Count
- MOBILENET-V2_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/models/mobilenet-v2/plc
    ↓
SCADA Systems (L2) - /os/models/mobilenet-v2/scada.html
    ↓
MES Layer (L3) - /os/models/mobilenet-v2/
    ↓
Business Layer (L4)
```

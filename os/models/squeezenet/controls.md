# Controls Definition
**UUID:** 9aaf81a7-a115-4274-b8da-f3ad4ac352d4
**ISA-95 Level:** L3 MES
**Directory:** `/os/models/squeezenet/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `squeezenet` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/models/squeezenet/plc`
- **Interface:** `os/models/squeezenet/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/models/squeezenet/hmi.html`
...
- **Path:** `/os/models/squeezenet/scada.html`
...
Examples:
- SQUEEZENET_PLC_Status_Running
- SQUEEZENET_HMI_Alarm_Count
- SQUEEZENET_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/models/squeezenet/plc
    ↓
SCADA Systems (L2) - /os/models/squeezenet/scada.html
    ↓
MES Layer (L3) - /os/models/squeezenet/
    ↓
Business Layer (L4)
```

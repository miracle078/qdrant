# Controls Definition
**UUID:** f795aff7-0f92-47c5-b77d-a01ad09d2563
**ISA-95 Level:** L3 MES
**Directory:** `/os/models/resnet18/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `resnet18` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/models/resnet18/plc`
- **Interface:** `os/models/resnet18/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/models/resnet18/hmi.html`
...
- **Path:** `/os/models/resnet18/scada.html`
...
Examples:
- RESNET18_PLC_Status_Running
- RESNET18_HMI_Alarm_Count
- RESNET18_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/models/resnet18/plc
    ↓
SCADA Systems (L2) - /os/models/resnet18/scada.html
    ↓
MES Layer (L3) - /os/models/resnet18/
    ↓
Business Layer (L4)
```

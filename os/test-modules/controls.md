# Controls Definition
**UUID:** 0526e648-fb9f-4307-8101-e87fab0ce145
**ISA-95 Level:** L3 MES
**Directory:** `/os/test-modules/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `test-modules` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/test-modules/plc`
- **Interface:** `os/test-modules/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/test-modules/scada.html`
...
Examples:
- TEST-MODULES_PLC_Status_Running
- TEST-MODULES_HMI_Alarm_Count
- TEST-MODULES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/test-modules/plc
    ↓
SCADA Systems (L2) - /os/test-modules/scada.html
    ↓
MES Layer (L3) - /os/test-modules/
    ↓
Business Layer (L4)
```

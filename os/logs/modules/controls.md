# Controls Definition
**UUID:** 5854f18f-4121-4e92-a7e7-fcd918c41c19
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/modules/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `modules` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/modules/plc`
- **Interface:** `os/logs/modules/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/logs/modules/scada.html`
...
Examples:
- MODULES_PLC_Status_Running
- MODULES_HMI_Alarm_Count
- MODULES_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/modules/plc
    ↓
SCADA Systems (L2) - /os/logs/modules/scada.html
    ↓
MES Layer (L3) - /os/logs/modules/
    ↓
Business Layer (L4)
```

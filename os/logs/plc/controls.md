# Controls Definition
**UUID:** 37c46509-2822-43f8-8729-8dc2a19fa135
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/plc/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `plc` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/plc/plc`
- **Interface:** `os/logs/plc/plc.html`
- **Scan Time:** 500ms-1s
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/plc/plc
    ↓
SCADA Systems (L2) - /os/logs/plc/scada.html
    ↓
MES Layer (L3) - /os/logs/plc/
    ↓
Business Layer (L4)
```

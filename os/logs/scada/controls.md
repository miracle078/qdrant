# Controls Definition
**UUID:** eeac0777-b934-46d4-bf11-cffb3a83afdd
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/scada/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `scada` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/scada/plc`
- **Interface:** `os/logs/scada/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- SCADA_PLC_Status_Running
- SCADA_HMI_Alarm_Count
- SCADA_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/scada/plc
    ↓
SCADA Systems (L2) - /os/logs/scada/scada.html
    ↓
MES Layer (L3) - /os/logs/scada/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 0f8a75f6-d1c7-4926-81d8-0a5fce8504d0
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/audit/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `audit` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/audit/plc`
- **Interface:** `os/logs/audit/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- AUDIT_PLC_Status_Running
- AUDIT_HMI_Alarm_Count
- AUDIT_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/audit/plc
    ↓
SCADA Systems (L2) - /os/logs/audit/scada.html
    ↓
MES Layer (L3) - /os/logs/audit/
    ↓
Business Layer (L4)
```

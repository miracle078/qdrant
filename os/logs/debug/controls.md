# Controls Definition
**UUID:** 0bb9a047-6e12-4f32-9761-78dc825c6bf9
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/debug/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `debug` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/debug/plc`
- **Interface:** `os/logs/debug/plc.html`
- **Scan Time:** 500ms-1s
...
Examples:
- DEBUG_PLC_Status_Running
- DEBUG_HMI_Alarm_Count
- DEBUG_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/debug/plc
    ↓
SCADA Systems (L2) - /os/logs/debug/scada.html
    ↓
MES Layer (L3) - /os/logs/debug/
    ↓
Business Layer (L4)
```

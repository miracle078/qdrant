# Controls Definition
**UUID:** 7b382bee-88ab-4b1c-a184-d1a8709d1aba
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/security/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `security` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/security/plc`
- **Interface:** `os/logs/security/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/logs/security/hmi.html`
...
- **Path:** `/os/logs/security/scada.html`
...
Examples:
- SECURITY_PLC_Status_Running
- SECURITY_HMI_Alarm_Count
- SECURITY_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/security/plc
    ↓
SCADA Systems (L2) - /os/logs/security/scada.html
    ↓
MES Layer (L3) - /os/logs/security/
    ↓
Business Layer (L4)
```

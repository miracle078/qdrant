# Controls Definition
**UUID:** da71cd74-dcb4-462c-a7e1-6b343c0ee814
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/api/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `api` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/api/plc`
- **Interface:** `os/logs/api/plc.html`
- **Scan Time:** 500ms-1s
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/api/plc
    ↓
SCADA Systems (L2) - /os/logs/api/scada.html
    ↓
MES Layer (L3) - /os/logs/api/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** cfdeee2d-22a0-42b0-9f2d-8500c382529a
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/boot/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `boot` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/boot/plc`
- **Interface:** `os/logs/boot/plc.html`
- **Scan Time:** 500ms-1s
- **Tags:** ~18 process variables
- **Mode:** RUN
- **Logic:** Ladder logic, structured text, function blocks

### HMI (Human-Machine Interface)
- **Path:** `/os/logs/boot/hmi.html`
...
Examples:
- BOOT_PLC_Status_Running
- BOOT_HMI_Alarm_Count
- BOOT_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/boot/plc
    ↓
SCADA Systems (L2) - /os/logs/boot/scada.html
    ↓
MES Layer (L3) - /os/logs/boot/
    ↓
Business Layer (L4)
```

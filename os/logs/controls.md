# Controls Definition
**UUID:** ada224c6-5426-4f95-b6dc-c980627a0e68
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/`
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/plc
    ↓
SCADA Systems (L2) - /os/logs/scada.html
    ↓
MES Layer (L3) - /os/logs/
    ↓
Business Layer (L4)
```

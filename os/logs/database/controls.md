# Controls Definition
**UUID:** a82d63d3-b230-4ea0-b706-bdc577910bed
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/database/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `database` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/database/plc`
- **Interface:** `os/logs/database/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/logs/database/hmi.html`
...
- **Path:** `/os/logs/database/scada.html`
...
Examples:
- DATABASE_PLC_Status_Running
- DATABASE_HMI_Alarm_Count
- DATABASE_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/database/plc
    ↓
SCADA Systems (L2) - /os/logs/database/scada.html
    ↓
MES Layer (L3) - /os/logs/database/
    ↓
Business Layer (L4)
```

# Controls Definition
**UUID:** 4be7da93-3c44-4c20-a178-450f30bcccc5
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/system/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `system` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/system/plc`
- **Interface:** `os/logs/system/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/logs/system/scada.html`
...
Examples:
- SYSTEM_PLC_Status_Running
- SYSTEM_HMI_Alarm_Count
- SYSTEM_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/system/plc
    ↓
SCADA Systems (L2) - /os/logs/system/scada.html
    ↓
MES Layer (L3) - /os/logs/system/
    ↓
Business Layer (L4)
```

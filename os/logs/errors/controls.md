# Controls Definition
**UUID:** 5baf4934-2da4-4d53-93a6-4f70e8ce1a39
**ISA-95 Level:** L3 MES
**Directory:** `/os/logs/errors/`

## Overview

This directory represents a control area in the system hierarchy. It contains interfaces for PLC logic, HMI panels, and SCADA monitoring specific to the `errors` subsystem.

## Control Pathways

### PLC (Programmable Logic Controller)
- **Path:** `/os/logs/errors/plc`
- **Interface:** `os/logs/errors/plc.html`
- **Scan Time:** 500ms-1s
...
- **Path:** `/os/logs/errors/scada.html`
...
Examples:
- ERRORS_PLC_Status_Running
- ERRORS_HMI_Alarm_Count
- ERRORS_SCADA_Data_Rate
```
...
Physical Devices (L0)
    ↓
PLC Controllers (L1) - /os/logs/errors/plc
    ↓
SCADA Systems (L2) - /os/logs/errors/scada.html
    ↓
MES Layer (L3) - /os/logs/errors/
    ↓
Business Layer (L4)
```
